...
<body>
    <div class="align">
	   <div class="header">
       <!--<img class="scroll" src="logo.png" align="middle"> -->
       <a herf="#"><img src="{{ asset('assets/images/zoin-logo.png') }}"  class="scroll" align="middle" /></a>
       </div>
       <div class="page">
         <div class="mark">
		     <h2 class="head">Hi Admin,</h2>
			 <p> New Member Requested For Zoin Account</p>			 
			 ...
			 <div style="margin-left: 50px;">
                ...
                <p><strong> Email id:</strong><a href="#"> {{ $email_id }} </a></p>
